...
interface IScriptSystem {
	...
	virtual SScriptFuncHandle* GetFunctionPtr(const char* sFuncName) = 0; //21
	virtual SScriptFuncHandle* AddFuncRef(SScriptFuncHandle* f) = 0; //22
	virtual bool CompareFuncRef(SScriptFuncHandle* f1, SScriptFuncHandle* f2) = 0; //23
	virtual void ReleaseFunc(SScriptFuncHandle* f) = 0; //24
	virtual ScriptAnyValue CloneAny(const ScriptAnyValue& any) = 0; //25
	virtual void ReleaseAny(const ScriptAnyValue& any) = 0; //26
	virtual void PushFuncParamAny(const ScriptAnyValue& any) = 0; //27
	virtual void SetGlobalAny(const char* sKey, const ScriptAnyValue& any) = 0; //28
